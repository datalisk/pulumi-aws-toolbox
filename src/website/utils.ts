 ...
 */
export function createBucketPolicyStatement(bucketArn: pulumi.Input<string>, distributionArn: pulumi.Input<string>, pathPattern: pulumi.Input<string>): aws.iam.PolicyStatement {
    return {
        Effect: "Allow",
        Principal: {
